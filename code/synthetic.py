...
def validate_solution(all_influencers: Set[User], num_users: int) -> bool:
    """
    ...
    :return: True if the input is optimal, and False if otherwise
    """
    ...
    return valid and (num_users == len(visited_global))
